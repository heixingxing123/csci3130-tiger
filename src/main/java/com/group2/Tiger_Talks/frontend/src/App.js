...
import AuthenticationFailPage from "./pages/Authentication/AuthenticationFailPage";
...
import ValidationFailPage from "./pages/Admin/ValidationFailPage";
import AdminFailPage from "./pages/Admin/AdminFailPage";
